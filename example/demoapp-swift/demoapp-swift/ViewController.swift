...
let kBackendChargeURL = "http://218.244.151.190/tests/ch_afon.php" // 你的服务端创建并返回 charge 的 URL 地址，此地址仅供测试用。
...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        let postDict : AnyObject = NSDictionary(objects: ["upacp", "10"], forKeys: ["channel", "amount"])
